...
C
 1000 CALL GETCHR (PROMPT, LINE, M)
      IF (M .LT. 0) GO TO 9100
      IF ((LINE(1:M) .EQ. 'E') .OR. (LINE(1:M) .EQ. 'e')) GO TO 9100
...
C
 ...
 1004    IF (N .LT. 71) THEN
            ...
            GO TO 1004
         END IF
         READ (LINE,903) NL, NCOL, NROW, LOBAD, HIBAD, THRESH, 
...
C
 ...
 1005    IF (N .LT. 69) THEN
            ...
            GO TO 1005
         END IF
         READ (LINE,901) NL, NCOL, NROW, LOBAD, HIBAD, THRESH, 
     .        AP1, PHPADU, READNS, FRAD
      ELSE IF ((TEST .NE. 'LOWB') .AND. (TEST .NE. 'OWBA')) THEN
C
C Obsolete file header.
C
         READ (LUN,901) NL, NCOL, NROW, THRESH, AP1, PHPADU, READNS, 
     .        LOBAD, FRAD
