...
C
      ...
      ELSE
         Z = Y/X
         AT360 = ATAN(Z)
         IF (X .LT. 0.) AT360 = AT360+3.141593
      END IF
      IF (AT360 .LT. 0.) AT360 = AT360+6.283185
      RETURN
      END
C
C#######################################################################
...
c           CALL GTFM (X, Y, COL, ROW, COEFF, MODE, XX, YY)
c           CALL GTFM (XX, YY, COLM, ROWM, FFEOC, MODE, XXX, YYY)
