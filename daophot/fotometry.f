...
C
      ...
      PARAMETER  (MINSKY=20, MAXAP=12, MAXSTR=450 000)
C
C Parameters:
C
...
CC
CC If ESTMTR is 0 use the mode; if ESTMTR is 1 use the median;
CC if it is 2 use the mean.
CC
C
C For routine NEDA,  *ALWAYS* use the median!
C
c     I = NINT(ESTMTR)
c     IF (I .EQ. 1) THEN
         SKYMOD = SKYMED
...
C in the star aperture, set the magnitude to 97.999.
C
