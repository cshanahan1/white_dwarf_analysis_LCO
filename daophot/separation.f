      parameter (max= 500 000)
c      parameter (max=10 000 000)
      character*2500 line(max)
...
c         read (line(n),*) id(n), x(n), y(n),   
c     #   ff 
c     #   xa,xb, xc,xd,ff   !!!xe,xf, ff  !xg,xh, ff      !xc,xd, xe,xf, xg,xh, xi,xj, ff,xj, xi,xj, xi,xj   !16 per      #    xa,xb, xc,xd,xe,xf, ff  !xg,xh, ff      !xc,xd, xe,xf, xg,xh, xi,xj, ff,xj, xi,xj, xi,xj   !16 per banda R 
      end if
      if (ff .gt. 50.) then
         if (null .eq. 0) then
