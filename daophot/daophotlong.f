...
C
     ...
     .     MAXSKY, MAXPAR
      PARAMETER (MAXCOL=8192, MAXROW=8192)

c      PARAMETER (MAXCOL=20000, MAXROW=20000)
...
C
      INTEGER MIN0, ICNVRT
C
      CHARACTER MSGLINE*264, HEAD3*80
      CHARACTER FILE*30, OPTFIL*30, MSGFIL*30, CASE*30
      CHARACTER ANSWER*1
...
C
     ...
     .            0., -3., 1., .5, -1.5, -0.5, -7.49, 0., 0., 0., 0./
      DATA OMAX / 1.E30, 1.E30, 1.E30, 999999.99, 20., 1.E30, 1.0,
...
C
      IMPLICIT NONE
      CHARACTER LINE*132, IFILE1*30, IFILE2*30, SWITCH*30, CASE*4
...
C
      ...
      CHARACTER FILE*30, SWITCH*30, STRNG1*9, STRNG2*9
      CHARACTER CASE*4
      REAL DELTA(4)
