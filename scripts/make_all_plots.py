...
def make_plot_0(base_path, phot_output_tab, plot_output_dir, stable_star_tab, unstable_star_tab, targname):
	...
	plt.savefig('/Users/cshanahan/Desktop/'+targname+'_var_idx_mag.pdf',dpi = 800, format = 'pdf')
...
def make_mjd_groups(stable_group_tab, plot_output_dir, base_path):
	...
	fits0 = glob.glob(base_path+'/*[0-9].fits')[0]
	ra_field, dec_field = fits.open(fits0)[0].header['ra'], fits.open(fits0)[0].header['dec']
	c = SkyCoord(ra=ra_field, dec=dec_field, frame='icrs',unit=(u.hourangle, u.deg))
	greenwich = coord.EarthLocation.of_site('greenwich')
	ts = Time(mjds, format = 'mjd', location = greenwich)
	ltt_helio = ts.light_travel_time(c, 'heliocentric')
	mjd_heliocentre = ts.mjd + ltt_helio.value
	print obs_info_tab['mjd-obs']
	obs_info_tab['mjd-obs'] = mjd_heliocentre
	print obs_info_tab['mjd-obs']
...
def make_plot_3(stable_group_tab, plot_output_dir, base_path,WD_mag_0,WD_tab,mjd_bin, \
	...
	obs_info_tab = base_path + '/obs_info.csv'
	print(WD_tab['ra_ref'],WD_tab['dec_ref'])
	obs_info_tab = ascii.read(obs_info_tab)
	plt.figure(figsize = (20,10))
	mjd_all_stars = []
	mean_all_stars = []
...
if __name__ == '__main__':
	...
	# targs = ['WD0418-534', 'WD1529-772', 'WD2314-293', 'WD1203-272',
	# 		 'A020.503022', 'SSSJ143459', 'SSSJ023824', 'SSSJ095657',
	# 		 'SSSJ193018', 'SSSJ045822', 'SSSJ063941', 'SSSJ054114',
	# 		 'SSSJ183717', 'SSSJ105525']
	...
	# all_23_targs = ['SDSSJ010322.19-002047.7','SDSSJ022817.16-082716.4','SDSSJ024854.96+334548.3','SDSSJ041053.632-063027.580','SDSSJ072752.76+321416.1',
 	...
 	targs = ['SDSSJ120650.504+020143.810', 'SDSSJ130234.43+101238.9']

	#targs = ['WD0418-534']
	for targname in targs:
		base_path = '/Users/cshanahan/Desktop/clean_desktop/WD_project/redo_final_ver/23_northern_targets/psf_phot/{}/'.format(targname)
