...
def construct_phot_table(targname,base_path,plot_output_dir):
	...
	parse_output_files(targname,ref_file,mch_file,cor_file,mag_file,plot_output_dir)
	print '*************************************************'
...
def find_wd(targname, plot_output_dir,phot_output_tab,ref_file, delta_ra_dec = 0.001):
	...
	print plot_output_dir + 'WD_tab.csv'
...
def write_close_mag_tab(phot_output_tab,ref_file,plot_output_dir,WD_id,WD_mag_0,delta_mag = 0.25,exclude_star_ids = []):
	...
	print 'Finding stars close in magnitude.'
	...
	while len_close_mag < 20:
		...
		print delta_mag + n_inc, len_close_mag
...
if __name__ == '__main__':
	...
	#targname = 'WD0554-165'
	#base_path = '/Users/cshanahan/Desktop/WD_project/redo_final_ver/23_targets/ap_phot/{}/'.format(targname)
	#plot_output_dir = base_path + 'plots_and_output/'
 	
 	targs = ['/Users/cshanahan/Desktop/WD_project/redo_final_ver/23_targets/psf_phot/SDSSJ022817.16-082716.4']
 			 
	#targs = ['SSSJ193018']
	for targ in targs:
		#dir = '/Users/cshanahan/Desktop/WD_project/redo_final_ver/23_targets/psf_phot/' + targ + ''
		dir = targ
		targname = dir.split('/')[-1]
		...
		main_choose_comparison_stars(targname, base_path, plot_output_dir, \
								 save_cutout_WD = False, save_cutout_stable_stars = False)
